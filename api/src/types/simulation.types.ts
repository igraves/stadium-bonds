import type { BondParams } from './bond.types.js';
import type { RevenueStream } from './revenue.types.js';
...
/**
 * Revenue calculation result (intermediate)
 */
export interface RevenueCalculation {
  year: number[];
  streamRevenues: Record<string, number[]>;
